...
def profile_view(request,*args,**kargs):
    context = {
        'need_to_pay':User.objects.get(username=request.user).useradditionalinformation.money_to_pay != 0
    }
    return render(request,'users_pages/users_profile.html',context)